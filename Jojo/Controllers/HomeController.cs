...
namespace Jojo.Controllers
{
    public class HomeController : Controller
    {
       ...
       public async Task<IActionResult> Register(User user, string confirmPassword)
        ...
        public List<UnreadMessageCount> GetUnreadMessageCount(string username)
        {
            List<UnreadMessageCount> unreadMessageCounts = new List<UnreadMessageCount>();
            ...
            {
                var unreadMessagesCount = _context.ChatMessages.Count(m => m.ChatId == chat.Id && !m.IsRead && m.Username != username);

                unreadMessageCounts.Add(new UnreadMessageCount
                {
